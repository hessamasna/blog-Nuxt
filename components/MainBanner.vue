<template>
  <div class="flex flex-col items-center py-16 ">
    <div class="">
      ...
      >
        <div class="flex flex-col gap-8 flex-shrink-0 items-center h-1/2">
          <svg class="h-1/2" viewBox="0 0 68 54" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <div class="font-extrabold text-5xl text-green-500"> WebJar</div>
        </div>
      </TransitionRoot>
    </div>
  </div>
